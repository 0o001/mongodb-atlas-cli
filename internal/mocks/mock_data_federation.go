...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store (interfaces: DataFederationStore,DataFederationLister,DataFederationDescriber)
...
func (m *MockDataFederationStore) DataFederation(arg0, arg1 string) (*mongodbatlas.DataFederationInstance, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataFederationStore) DataFederationList(arg0, arg1 string) ([]*mongodbatlas.DataFederationInstance, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataFederationStoreMockRecorder) DataFederationList(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DataFederationList", reflect.TypeOf((*MockDataFederationStore)(nil).DataFederationList), arg0, arg1)
}
...
// DataFederationList mocks base method.
func (m *MockDataFederationLister) DataFederationList(arg0, arg1 string) ([]*mongodbatlas.DataFederationInstance, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DataFederationList", arg0, arg1)
	ret0, _ := ret[0].([]*mongodbatlas.DataFederationInstance)
	ret1, _ := ret[1].(error)
...
// DataFederation mocks base method.
func (m *MockDataFederationDescriber) DataFederation(arg0, arg1 string) (*mongodbatlas.DataFederationInstance, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DataFederation", arg0, arg1)
	ret0, _ := ret[0].(*mongodbatlas.DataFederationInstance)
	ret1, _ := ret[1].(error)
